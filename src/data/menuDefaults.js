...
const DEFAULT_SECTIONS = [
  ...
  { section_key: 'analysis', section_label: '분석', display_order: 4, is_system: 0 },
  { section_key: 'comm', section_label: '소통', display_order: 5, is_system: 0 },
  { section_key: 'ai', section_label: 'AI 기능', display_order: 6, is_system: 0 },
  // system 섹션은 관리자/설정/개발자옵션 등 시스템 필수 메뉴 — hide 불가
  { section_key: 'system', section_label: '시스템', display_order: 7, is_system: 1 },
];
